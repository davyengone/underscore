...
describe('uniq', function() {
  ...
  it('should handle iterators that work with a sorted array', function() {
    let iterator = function(value) { return value +1; };
...
describe('map', function() {
  it('should apply a function to every value in an array', function() {
    let doubled = _.map([1, 2, 3], function(num) {
      return num * 2;
    });
...
describe('invoke, when provided a function reference', function() {
  it('runs the input function on each item in the array, and returns a list of results', function() {
    ...
    let reversedStrings = _.invoke(['dog', 'cat'], reverse);
...
describe('invoke, when provided a method name', function() {
  it('runs the specified method on each item in the array, and returns a list of results', function() {
    let upperCasedStrings = _.invoke(['dog', 'cat'], 'toUpperCase');
...
//   let nativeSome = Array.prototype.some;
...
//     let to = {};
//     let from = {};
//     let defaulted = _.defaults(to, from);
...
//     let from = {a: 1};
//     let alsoFrom = {a: 2};
//     let defaulted = _.defaults(to, from, alsoFrom);
...
// describe('delay', function() { let clock; beforeEach(function() {
...
//     let result = _.sortBy(list, function(i) { return i; });
...
//     let sorted = _.sortBy(list, 'length');
...
//     let actual = _.sortBy(collection, function(pair) {
//       return pair.x;
//     });
...
//     let diff = _.difference([1,2,3], [2,30,40]);

//     expect(diff).to.eql([1,3]);
//   });

//   it('should return the difference between three arrays', function() {
//     let result = _.difference([1, 2, 3, 4], [2, 30, 40], [1, 11, 111]);
...
//       return ++counter;
//     };
//     let throttledIncr = _.throttle(incr, 64);
//     let results = [];
